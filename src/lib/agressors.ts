import { MAPPED_INDICATORS_AGRESSORS, MAPPED_INDICATORS_AGRESSORS_VALUES, LIST_MUNICIPALITIES } from '@/constants'
import { fixEncoding, isValidDate, parseDate, prisma } from './util'
import { type Agressor } from '@prisma/client'

export const handleReducerAgressors = (acc: Record<string, string | number | boolean | Date>, cur: string, idx: number, columns: string[]) => {
